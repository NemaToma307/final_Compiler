...
public interface projectParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link projectParser#integer}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link projectParser#class}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass(projectParser.ClassContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code container_withflutterWidget}
	 * labeled alternative in {@link projectParser#containerStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContainer_withflutterWidget(projectParser.Container_withflutterWidgetContext ctx);
	/**
